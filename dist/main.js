...
let projects = [];
let projectAll = new _project__WEBPACK_IMPORTED_MODULE_1__["default"]('All');
let projectToday = new _project__WEBPACK_IMPORTED_MODULE_1__["default"]('Today');
let projectThisWeek = new _project__WEBPACK_IMPORTED_MODULE_1__["default"]('This Week');
...
function renderForm(project) {
    ...
    formbutton.addEventListener('click', function formListener(e) {
        ...
        let task = new _task_js__WEBPACK_IMPORTED_MODULE_0__["default"](name, description, new Date(date), priority, done);
...
function createProject() {
    ...
    let project = new _project__WEBPACK_IMPORTED_MODULE_1__["default"](input.value);
...
class Project {
    ...
    sortByDate() {
        this.tasks.sort(function compare(a, b) {
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(a.getDueDate(), b.getDueDate())
        });
    }
    ...
    getTodayTasks() {
        return this.tasks.filter((task) => {
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.getDueDate())
        })
    }

    getThisWeekTasks() {
        return this.tasks.filter((task) => {
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.getDueDate(), 1)
        })
    }
...
class task {
    ...
    getFormatDate() {
        ...
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(Date, 'dd/MM/yy');
    }
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dom_functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom_functions */ "./src/dom_functions.js");


(0,_dom_functions__WEBPACK_IMPORTED_MODULE_0__["default"])();

/*
Whats left: localstorage, removing projects
*/
